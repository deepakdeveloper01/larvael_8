...
@endif --}}
				...
				<div class="card-body">
				  {!! Form::open(['spellcheck'=>'true','files'=>true, 'route' => 'cms-pages.store' ,'id'=>"article-form"]) !!}
				  	@include('admin.cms-page.form')
			
               <div class="card-footer">
                <button type="submit" id="submitCmsPageForm" class="btn btn-primary"><i class="fas fa-list"> </i>      Add </button>
